<?php  
  ...
  if (mysqli_connect_errno())
  {
   ...
   echo "Start date is ".$start." <br/> till ".$till;
      ...
      $response=mysqli_query($conn, "SELECT CID FROM(SELECT CID, SUM(PRICESOLD) FROM CART JOIN APPEARS_IN ON CART.CARTID=APPEARS_IN.CARTID GROUP BY CID ORDER BY SUM(PRICESOLD) DESC LIMIT 10) AS X ");
      ...
      {        
        ...
        $str.= "<tr><td>"."Customer ID: ". $row['CID']."</td></tr>";
      }
        $str.= "</table>";
      }
      return $str;
