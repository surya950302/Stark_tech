<?php  
  ...
  if (mysqli_connect_errno())
  {
   ...
   echo "Start date is ".$start." <br/> till ".$till;
      ...
      $response=mysqli_query($conn, "SELECT AVG(PRICESOLD) FROM APPEARS_IN WHERE PID BETWEEN 3000 AND 3999 ");
      ...
      {        
        ...
        $str.= "<tr><td>"."The Average Price of Printers Sold is: ". $row['AVG(PRICESOLD)']."</td></tr>";
      }
        $str.= "</table>";
      }
      return $str;
