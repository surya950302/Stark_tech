<?php  
  ...
  if (mysqli_connect_errno())
  {
   ...
   echo "Start date is ".$start." <br/> till ".$till;
      ...
      $response=mysqli_query($conn, "SELECT COUNT(CARTID),ZIP FROM CART JOIN SHIPPING_ADDRESS ON CART.CID=SHIPPING_ADDRESS.CID GROUP BY ZIP ORDER BY COUNT(CARTID) DESC ");
      ...
      {        
        ...
        $str.= "<tr><td>". "Numerb of Orders: ".$row['COUNT(CARTID)']."</td></tr>"."<tr><td>"."Zip Code: ".$row['ZIP']."</td></tr>";
      }
        $str.= "</table>";
      }
      return $str;
