<?php  
  ...
  $query3 = " SELECT S.SANAME, S.RECIPIENTNAME, S.STREET, S.SNUMBER, S.CITY, S.STATE, S.ZIP, S.COUNTRY FROM SHIPPING_ADDRESS AS S, CUSTOMER AS C, WHERE S.CID = C.CID AND C.CUSERNAME = '$username' ";
  ...
  if($row3 = $result3->fetch_assoc())
  {
    ...
    {
      $s.=ship($rowcount3,$row3);
    }
        
  }
  else
  {
    $s.="<center><P> No Details available: It appears that you dont have a Shipping Address</P>";
    $s.="<a href='Shipping.php'>Add new</a><br><br></center>";
  ...
  Function ship($rowcount, $row)
  {
    $str="<P> SHIPPING ADDRESS NAME: ".$row['SANAME']."</P>";
      $str.="<P> RECIPIENT NAME: ".$row['RECIPIENTNAME']."</P>";
      $str.="<P> STREET: ".$row['STREET']."</P>";
      $str.="<P> STREET NUMBER: ".$row['SNUMBER']."</P>";
      $str.="<P> CITY: ".$row['CITY']."</P>";
      $str.="<P> STATE: ".$row['STATE']."</P>";
      $str.="<P> ZIP: ".$row['ZIP']."</P>";
      $str.="<P> COUNTRY: ".$row['COUNTRY']."</P>";
...
<div class="mdl-layout mdl-js-layout">
  ...
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="Shipping.php">Edit Shipping Address</a>
